...
<head>
    ...
    <style>
        ...
        @media (max-width: 767px) {
            #schedule-table td { padding: 0.25rem 0.2rem; }
            #schedule-table .match-players { gap: 0.15rem; }
            #schedule-table .player-name-full { display: none; }
            #schedule-table .player-name-short { display: inline; }
            #schedule-table .player-badge { padding: 0.15rem 0.3rem; font-size: 10px; }
        }
        @media print {
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr v-for="(m, idx) in displayedMatches" :key="m.spieltag"
                        ...
                        <td class="py-2 px-1.5">
                            <div class="match-players flex flex-wrap items-center gap-1">
                        ...
                        <td class="py-2 px-1.5">
                            ...
                            <div v-else class="match-players flex flex-wrap items-center gap-1">
